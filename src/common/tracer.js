...
function initTracing (config) {
  // Read global options and exclude 'dataDogEnabled' 'lightStepEnabled' 'signalFXEnabled'
  const globalOptions = _.omit(config, 'dataDogEnabled', 'lightStepEnabled', 'signalFXEnabled')
